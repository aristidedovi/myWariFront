...
export class ComptesService {
  ...
  getOnePartenaires(id): Observable<any> {
    return this.http
      .get<any>(environment.apiUrl + "/api/partenaires/" + id)
      .pipe(
        map((data) => data),
        retry(1),
        catchError(this.handleError)
  ...
  createCompte(compte: any): Observable<any> {
    return this.http
      .post<any>(environment.apiUrl + "/api/creation_compte", compte)
      .pipe(
        map((data) => data),
        retry(1),
        catchError(this.handleError)
  ...
  deleteCompte(id: number): Observable<any> {
    return this.http
      .delete<any>(environment.apiUrl + "/api/comptes/" + id)
      .pipe(
        map((data) => data),
        retry(1),
        catchError(this.handleError)
  ...
  deletePartenaire(id: number): Observable<any> {
    return this.http
      .delete<any>(environment.apiUrl + "/api/partenaires/" + id)
      .pipe(
        map((data) => data),
        retry(1),
        catchError(this.handleError)
  ...
  updatePartenaire(partenaire: any, id: number): Observable<any> {
    return this.http
      .put<any>(environment.apiUrl + "/api/partenaires/" + id, partenaire)
      .pipe(
        map((data) => data),
        retry(1),
        catchError(this.handleError)
